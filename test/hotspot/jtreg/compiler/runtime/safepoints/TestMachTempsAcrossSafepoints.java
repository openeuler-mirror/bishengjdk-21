 ...
 * @key randomness
 * @library /test/lib /
 * @comment AArch64-only because this checks AArch64 G1 MachTemp barrier shapes.
 * @requires vm.gc.G1 & vm.bits == 64 & vm.opt.final.UseCompressedOops == true & os.arch == "aarch64"
