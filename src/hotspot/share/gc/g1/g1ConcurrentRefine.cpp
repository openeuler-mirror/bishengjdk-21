...
void G1ConcurrentRefineSweepState::snapshot_heap_inner() {
  ...
  class SnapshotRegionsClosure : public HeapRegionClosure {
    G1CardTableClaimTable* _sweep_table;

  public:
    SnapshotRegionsClosure(G1CardTableClaimTable* sweep_table) : HeapRegionClosure(), _sweep_table(sweep_table) { }
...
void G1ConcurrentRefine::notify_region_reclaimed(HeapRegion* r) {
  assert_at_safepoint();
