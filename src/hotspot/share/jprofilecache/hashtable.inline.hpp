 ...
 */
 ...
 #ifndef SHARE_JPROFILECACHE_HASHTABLE_INLINE_HPP
 #define SHARE_JPROFILECACHE_HASHTABLE_INLINE_HPP
 ...
 template <MEMFLAGS F> inline BasicHashtableEntry<F>* HashtableBucket<F>::get_entry() const {
   ...
   //          complete before other threads can be allowed to see it
   //          via a store to _buckets[index].
   return (BasicHashtableEntry<F>*) Atomic::load_acquire(&_entry);
 }
 ...
 #endif // SHARE_JPROFILECACHE_HASHTABLE_INLINE_HPP
